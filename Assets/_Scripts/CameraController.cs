...
{
    // Distance from screen edge. Used for mouse movement
    ...
    void Update()
    {
        ...
        // Increase pan speed for camera movement.
        ...
        #region Zoom
        var oldFieldOfView = Camera.main.fieldOfView;
        var newFieldOfView = oldFieldOfView - Input.mouseScrollDelta.y;

        Camera.main.fieldOfView = Mathf.Lerp(oldFieldOfView, newFieldOfView, zoomSpeed);
